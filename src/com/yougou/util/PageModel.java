...
public class PageModel<GitMoney> {
    ...
    public PageModel(int page, int limit, int totalCount, List<GitMoney> items) {
        this.page = page;
        this.limit = limit;
        this.totalCount = totalCount;
        this.pageCount = getTotalPageCount();
    ...
    public List<GitMoney> getItems() {
        return items;
    }

    public void setItems(List<GitMoney> items) {
        this.items = items;
    }
